...
window.onload = function () {
    document.body.insertAdjacentElement("afterbegin",header("../Styles/Header.css","../../../../Inicio.html"));
    document.body.insertAdjacentElement("beforeend",Footer("../Styles/Footer.css"));
